...
func main() { // 入口函数
	...
	e.From = "墨迹坤哥 <543882743@qq.com>"
	// [] ? Array? 多个用户发邮件 { }集合
	// go 静态类型
	e.To = []string{"1105317666@qq.com", "1416410928@qq.com"}
	e.Subject = "你在家还好吗？" //标题
	// byte? go 类型 byte  字节流
	...
	e.AttachFile("yb.jpg") // 附件
	err := e.Send("smtp.qq.com:25", smtp.PlainAuth("", "543882743@qq.com", "ugftautczyxjbfga", "smtp.qq.com"))
